...
public class UserQuery {
    ...
    public static final String SELECT_USER_BY_ID = "SELECT * FROM Users WHERE user_id = :userId";
    public static final String SELECT_ALL_USERS_PAGEABLE = "SELECT * FROM Users ORDER BY :sortBy LIMIT :size OFFSET :offset ";
}
